...
export const translations: Record<Language, TranslationContent> = {
  en: {
    ...
    footer: {
      ...
      stayConnectedBody: 'Follow us on Facebook for the latest news and updates.',
  ...
  so: {
    ...
    footer: {
      ...
      stayConnectedBody: 'Raac nala Facebook si aad ula socoto wararkii iyo cusboonaysiintii ugu dambeeyay.',
  ...
  ar: {
    ...
    footer: {
      ...
      stayConnectedBody: 'تابعونا على فيسبوك للحصول على آخر الأخبار والتحديثات.',
