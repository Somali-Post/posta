...
export const RugPudo = () => {
  ...
  const highlights = rugPudo.highlights ?? [];
  const roadmap = rugPudo.roadmap ?? [];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-3xl bg-gradient-to-r from-white/20 to-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur">
              <p className="text-sm uppercase tracking-widest text-white/70">{rugPudo.whyTitle}</p>
              <p className="text-2xl font-bold mt-2">{rugPudo.whyHeading}</p>
              <p className="text-white/80 mt-3">{rugPudo.whyBody}</p>
            </div>
          </div>
        </div>
      </div>
